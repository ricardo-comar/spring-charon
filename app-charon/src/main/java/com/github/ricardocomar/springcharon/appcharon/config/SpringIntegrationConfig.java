...
public class SpringIntegrationConfig {
	...
	public static final String X_MSG_HEADER_SYNC_DOMAIN = "X-Charon-Sync-Domain";
	public static final String X_MSG_HEADER_SYNC_SEQUENCE = "X-Charon-Sync-Sequence";
	public static final String X_MSG_HEADER_SYNC_CONTROL = "X-Charon-Sync-Control";
	public static final String X_MSG_HEADER_SYNC_RETRY_COUNT = "X-Charon-Sync-Retry-Count";
	public static final String X_MSG_HEADER_SYNC_UPDATE_RESULT = "X-Charon-Sync-Update-Result";
	...
	public static final String X_MSG_HEADER_OUTBOUND_DENY_CAUSE = "X-Charon-Outbound-Deny-Cause";
